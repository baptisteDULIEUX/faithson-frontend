          ...
          <div class="block">
            ...
            <div class="methods">
              ...
              <label class="method disabled">
                <input type="radio" value="paypal" disabled /> PayPal <span class="soon">bientôt</span>
              </label>
            </div>
            ...
            <div class="callout">
              ...
              <div>Interface de paiement <b>maquettée</b> : aucune carte n'est réellement débitée.
                Le vrai encaissement passera par Stripe / PayPal côté backend Node
                (via <code>services/api.js → createOrder</code>).</div>
            </div>
          </div>
...
.method.disabled { opacity: 0.55; cursor: not-allowed; }
.soon { font-family: 'Caveat', cursive; color: var(--sage); font-size: 1rem; }
